...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactToEdit) {
        ...
        document.getElementById('addressUnitNumber').value = contactToEdit.address.unitNumber;
        document.getElementById('addressCivicNumber').value = contactToEdit.address.civicNumber;
        document.getElementById('addressCity').value = contactToEdit.address.city;
        document.getElementById('addressStreet').value = contactToEdit.address.street;
        document.getElementById('addressProvince').value = contactToEdit.address.province;
        document.getElementById('addressPostalCode').value = contactToEdit.address.postalCode;
    ...
    editContactForm.addEventListener('submit', (e) => {
        ...
        const updatedContact = {
            ...
            address:{
                unitNumber:document.getElementById('address_unitNumber').value,
                civicNumber: document.getElementById('addressCivicNumber').value,
